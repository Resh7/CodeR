      ...
      <div className="container-premium grid gap-10 lg:grid-cols-[.85fr_1.15fr]">
        <Reveal>
          ...
          <div className="mt-8 space-y-4">
            <a href="tel:+910000000000" className="premium-card flex items-center gap-4 rounded-2xl p-5 transition hover:-translate-y-1"><Phone className="text-blue-500"/><div><span className="block text-xs font-bold uppercase tracking-[.15em] text-slate-400">Call now</span><strong>Update phone number in CMS</strong></div></a>
            <a href="mailto:info@mohanasricnctechnics.com" className="premium-card flex items-center gap-4 rounded-2xl p-5 transition hover:-translate-y-1"><Mail className="text-blue-500"/><div><span className="block text-xs font-bold uppercase tracking-[.15em] text-slate-400">Email</span><strong>info@mohanasricnctechnics.com</strong></div></a>
            <a href="https://wa.me/910000000000" className="premium-card flex items-center gap-4 rounded-2xl p-5 transition hover:-translate-y-1"><MessageCircle className="text-blue-500"/><div><span className="block text-xs font-bold uppercase tracking-[.15em] text-slate-400">WhatsApp</span><strong>Start a conversation</strong></div></a>
            <a href={map} target="_blank" rel="noreferrer" className="premium-card flex items-center gap-4 rounded-2xl p-5 transition hover:-translate-y-1"><MapPin className="text-blue-500"/><div><span className="block text-xs font-bold uppercase tracking-[.15em] text-slate-400">Visit us</span><strong>Open in Google Maps</strong></div></a>
          </div>
        </Reveal>
        <Reveal delay={.1}>
